    ...
    const financeChart = new Chart(financeCtx, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: 'Ingresos',
                    data: [32000, 35000, 38000, 42000, 39000, 41000, 43000, 45000, 48000, 45280],
                    borderColor: '#2ecc71',
                ...
                {
                    label: 'Gastos',
                    data: [22000, 24000, 26000, 28000, 27000, 29000, 30000, 31000, 32000, 28450],
                    borderColor: '#e74c3c',
        ...
        options: {
            ...
            plugins: {
                ...
                title: {
                    display: true,
                    text: 'Evolución de Ingresos y Gastos - 2023'
                }
            }
        }
    });
